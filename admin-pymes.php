<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['house-title']) && isset($_POST['house-description']) && isset($_FILES['house-image'])) {
        ...
        if (!empty($_FILES['house-image']['name'])) {
            ...
            $consultaPublicacion = "INSERT INTO publicaciones (`titulo-publicacion`, `texto-publicacion`, `precio`, `id-apartado`) VALUES ('$houseTitle', '$houseDescription', '$housePrice', '3')";
                ...
                if (substr($imageType, 0, 5) === 'image') {
                    ...
                    if ($imageData !== false) {
                        ...
                        if (mysqli_stmt_execute($stmt)) {
                            ...
                            echo '<script>window.location.href = "admin-pymes.php";</script>';
                            exit();
                        } else {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete-house-select'])) {
        ...
        $query = "SELECT `id-publicacion` FROM `publicaciones` WHERE `titulo-publicacion` = '$selectedHouseId' AND `id-apartado` = 3";
...
<body>
    ...
    <center>
        <div class="content">
            ...
            <p>¡Aquí puedes gestionar tus publicaciones de PYMES!</p>

            <div class="change-form">
                <h3>Agregar Publicación</h3>
                <form action="./admin-pymes.php" method="post" enctype="multipart/form-data">
            ...
            <div class="change-form">
                ...
                <form action="admin-pymes.php" method="post">
                    ...
                    <select id="delete-house-select" name="delete-house-select" class="form-select select-large">
                        <?php
                            ...
                            // Realizar consulta a la base de datos para obtener las casas con id de apartado igual a 1
                            $query = "SELECT * FROM `publicaciones` WHERE `id-apartado` = 3";
                            $result = mysqli_query($conexion, $query);
