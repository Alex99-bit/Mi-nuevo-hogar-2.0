...
<body>
        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="creditos.php" class="nav-item nav-link active">Crédito Hipotecario</a>
    ...
    <div class="container-fluid page-header mb-5 position-relative overlay-bottom">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5" style="min-height: 400px">
            <h1 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase">Crédito Hipotecario</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <h1>¿Buscas el mejor crédito hipotecario?</h1>
            <br><br>
            <h2>¡Nosotros somos tu mejor opción!</h2>
            <p><strong>Te ofrecemos:</strong></p>
            <ul>
                <li>Créditos para adquisición de vivienda</li>
                <li>Créditos de liquidez</li>
                <li>Sustitución de hipoteca</li>
                <li>Remodelación</li>
                <li>Construcción</li>
            </ul>
            <p>Todas las opciones en un mismo lugar, contamos con el apoyo y confianza de los bancos más importantes del país</p>
            <p>Asesoría y trámite<strong> SIN COSTO</strong></p>
        </div>
    </div>
    <!-- Menu End -->
   ...
   <center>
    ...
    <script>
        function filtrarPublicaciones(filtro) {
            window.location.href = 'creditos.php?filtro=' + filtro;
        }
    ...
    <div class="container-fluid footer text-white mt-5 pt-5 px-0 position-relative overlay-top">
        <div class="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <a href="mailto:mcoronado@creditaria.com?subject=Créditos Hipotecarios y PYMES.&body=Me%20gustaría%20agendar%20una%20cita."><p class="m-0">mcoronado@creditaria.com</p></a><br>
